...
public class RegexConfig extends ModuleConfiguration {
	public String regularExpression = "";

	public RegexConfig(String moduleName, String version) {
		super(moduleName, version);
		fileFilter.addInclusiveMediaType("text");
	}

	public RegexConfig() {
		super("Regex text search", "0.5");
	}

	public boolean regexIsValid() {
